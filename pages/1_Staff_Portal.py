...
- Pre-auth: Ultra-Premium Double-Bezel 3D Glassmorphic Card with Rotating Laser Border Beam, Emblem, and Native Zero-Iframe Processing
- Transition: High-End Motion "Bars" Loader (4 kinetic pulsating glowing bars with crisp, concise status: "Signing in...")
- Post-auth: Full-Width Original Student Academic Performance Prediction System (app_3.py architecture with Sliders, Model Inference, Prediction Confidence, Probabilities Distribution Chart, SHAP Attribution, and Feature Importance)
"""
...
st.markdown("""
    ...
    /* 3D Double-Bezel Card Container */
    .card-shell-wrapper {
        position: relative;
        border-radius: 28px;
        padding: 2px;
    ...
    /* Motion "Bars" Loader Animation */
    .motion-bars-container {
        display: flex;
        align-items: center;
        justify-content: center;
        gap: 7px;
...
# =========================================================================
# 2. UNAUTHENTICATED STATE: LUXURY 3D CARD + NATIVE "BARS" LOADER
# =========================================================================
else:
    # Native Streamlit Back Link
    st.page_link("app.py", label="← Back to Home")

    st.markdown('<div class="ambient-top-glow"></div>', unsafe_allow_html=True)

    col1, col2, col3 = st.columns([1, 1.8, 1])

    with col2:
        st.markdown("""
            <div class="card-shell-wrapper">
                <div class="card-core-inner">
                    <div class="card-emblem-badge">S</div>
                    ...
                    <p style="text-align: center; font-size: 0.85rem; color: #94A3B8; margin: 0 0 20px 0;">Sign in to access student prediction analytics</p>
        """, unsafe_allow_html=True)
                        ...
                        with loader_ph.container():
                            st.markdown("""
                                <div style="text-align: center; padding: 12px 0;">
                                    <div class="motion-bars-container">
                                        <span class="motion-bar-item"></span>
                                        <span class="motion-bar-item"></span>
                                        <span class="motion-bar-item"></span>
                                        <span class="motion-bar-item"></span>
                                    </div>
                                    <div style="font-weight: 700; color: #CBD5E1; font-size: 0.95rem;">Signing in...</div>
                                </div>
                            """, unsafe_allow_html=True)
                        ...
                        with loader_ph.container():
                            st.markdown("""
                                <div style="text-align: center; padding: 12px 0;">
                                    ...
                                    <div style="font-weight: 700; color: #CBD5E1; font-size: 0.95rem;">Creating account...</div>
                                </div>
                            """, unsafe_allow_html=True)
