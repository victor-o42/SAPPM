...
if is_auth:
    ...
    st.markdown(f'<span class="hero-eyebrow">{icon("shield", size=14, color="#A5B4FC")} &nbsp;Verified Active Session</span>', unsafe_allow_html=True)
    ...
    with col2:
        ...
        with bcol2:
            if st.button("Browse Records", use_container_width=True):
                st.switch_page("pages/5_Student_Records.py")
