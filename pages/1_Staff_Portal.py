...
- Navigation: window.open(url, '_top') for 100% Guaranteed Top-Level Window Navigation (Zero Iframe Trapping, Zero Cramming)
...
# Global Scrollbar & Layout Styling: Complete Sidebar Suppression
st.markdown("""
    <style>
...
# Process incoming Supabase Auth requests
...
# =========================================================================
# 2. UNAUTHENTICATED STATE: 100% ORIGINAL PREMIUM 3D AUTH CARD
# =========================================================================
else:
    ...
    <body>
        ...
        <script>
            ...
            // 6. MOTION "BARS" LOADER TRIGGER & DIRECT TOP NAVIGATION
            ...
            function handleAuthAction(event, action) {{
                ...
                if (action === 'signin') {{
                    ...
                    // Show the kinetic "Bars" loader screen with clean short title
